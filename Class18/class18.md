...
Pertussis (known as whooping cough) is a highly contagious respiratory
disease caused by the bacterium Bordetella pertussis. People of all ages
can be infected leading to violent coughing fits followed by a
...
After the aP vaccine was introduced in 1996, pertussis cases started
increasing again. This may be because the acellular vaccine provides
shorter-lasting immunity than the earlier whole-cell vaccine, allowing
immunity to wane over time.

## Exploring CMI-PB data

We need to investigate the mechanisms underlying waning protection
against pertussis. This requires evaluation of pertussis-specific immune
responses over time in wP and aP vaccinated individuals.
...
The histogram shows that the wP group is generally older while the aP
group is younger, suggesting the two groups are significantly different.
...
```
           ...
           dataset     n
    1 2020_dataset 31520
    2 2021_dataset  8085
    3 2022_dataset  7301
    4 2023_dataset 15050

The datasets include 2020_dataset and 2021_dataset. The most recent
dataset has fewer rows compared to the older dataset, meaning there is
less data available from the newer study.
...
IgG titers change the most over time for antigens directly related to
Bordetella pertussis and the vaccine, such as PT and FIM2/3. These show
differences because the immune system was specifically exposed to them
through vaccination or boosting, whereas control or unrelated antigens
are not expected to trigger the same response.

**We can attempt to examine differences between wP and aP here by
setting color and/or facet values of the plot to include infancy_vac
status (see below). However these plots tend to be rather busy and thus
hard to interpret easily.**
...
The control antigen OVA does not show much change over time, but PT
shows a clear rise in antibody levels after boosting. This suggests that
PT is strongly recognized by the immune system, while OVA is not
expected to change because it is not part of the vaccine.

> Q17. Do you see any clear difference in aP vs. wP responses?

There seem to be some differences between aP and wP responses, but the
patterns are not always very clear from the plots alone. The effect
appears to depend on the antigen, with some showing more separation
...
The trend in the 2020 dataset is similar to the 2021 dataset. In both
cases, IgG levels against PT increase after the booster vaccination and
reach a peak around day 14 before leveling off, indicating a typical
...
The expression of IGHG1 increases after vaccination and appears to reach
its highest level at the later post-boost visits, especially around
visit 4. This suggests the gene is more actively expressed after the
immune response has been stimulated.

> Q21. Does this pattern in time match the trend of antibody titer data?
> If not, why not?

Not exactly. The RNA expression pattern and antibody titer trend are
related, but they do not peak at the same time because gene expression
happens before the final antibody proteins build up in circulation.
...
**There is however no obvious wP vs. aP differences here even if we
