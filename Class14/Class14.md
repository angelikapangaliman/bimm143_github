...
- [Clean up](#clean-up)
- [DESeq analysis/Setting up the DESeq
  object/RunningDESeq](#deseq-analysissetting-up-the-deseq-objectrunningdeseq)
...
Today we will do a pathway analysis from RNA-Seq results. Pathway
analysis (also known as gene set analysis or over-representation
...
> Q3. Q. Call the summary() function on your results to get a sense of
...
```
    ...
    Info: Working in directory /Users/angelikapangaliman/Desktop/BIMM143/bimm143_github/Class14
...
The cell cycle, Mitotic has the most significant “Entities p-value” Some
of the most significant pathways overlap conceptually with the KEGG
results especially those related to cell cycle regulation and
proliferation. Differences between Reactome and KEGG occur because each
database defines pathways differently, includes different gene sets, and
uses slightly different enrichment structures, which can change the
statistical ranking of pathways.
